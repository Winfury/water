...
export const getRouterData = app => {
  const routerConfig = {
    ...
    // 信息资源目录
    '/infoResources/infoResources-list': {
      component: dynamicWrapper(app, ['infoResources'], () => import('../routes/page/InfoResources/InfoResourcesList')),
    },
    '/infoResources/infoResources-form': {
    ...
    // 代码申请校验
    '/codeApplicationVerification/codeApplication-list': {
      component: dynamicWrapper(app, [], () => import('../routes/page/CodeApplicationVerification/CodeApplicationList')),
    },
    '/codeApplicationVerification/codeApplication-form': {
